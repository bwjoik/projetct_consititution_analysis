...
# Filted_csv = "C:/Users/user/OneDrive - 東吳大學/python/projetct_consititution_analysis/Filted_csv.csv"
...
# 過濾後檢查
# with open(Filted_csv, "w", newline="",encoding='utf-8-sig') as f:
#     writer = csv.writer(f)
#     writer.writerows(Filted)
